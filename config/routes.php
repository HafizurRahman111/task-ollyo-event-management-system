...
return [
    ...
    route('GET', '/ems/events/report/{id}', EventController::class, 'generateReport', [AuthMiddleware::class, $adminMiddleware], $idConstraint, 'events.generateReport'),
    route('GET', '/ems/attendees/delete/{id}', EventController::class, 'deleteAttendee', [AuthMiddleware::class, $adminMiddleware], $idConstraint, 'events.deleteAttendee'),
